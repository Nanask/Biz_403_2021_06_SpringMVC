...
public class BookDaoImplV1 implements BookDao {
	...
	public List<BookVO> selectAll() {
		...
		/*
		 * jdbcTemplate.query(sql,return type) sql문을 실행한 후 return type형태로 데이터를 변환하여
		 * return 해달라
		 */
	...
	public int insert(BookVO vo) {
		...
		Object[] params = new Object[] {
				...
				vo.getBk_isbn(), vo.getBk_title(), vo.getBk_ccode(), vo.getBk_acode(), vo.getBk_date(),
				vo.getBk_price(), vo.getBk_pages() };
