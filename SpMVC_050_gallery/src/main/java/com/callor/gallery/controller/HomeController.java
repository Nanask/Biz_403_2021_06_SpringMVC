...
public class HomeController {
	...
	// request를 처리할 method
	// a tag를 클릭했을 때 : <a href=${rootPath}/dumy/gallery/detail">클릭</a>
	// 주소창에 직접 입력하고 enter를 눌렀을 때 : localhost:8080/rootPath/dumy/gallery/detail
	// 스크립트에서 location.href=${rootPath}/dumy/gallery/detail 로 JS에서 실행했을 때
	 ...
	 * </form>
	 * 
	 * JSP, HTML에서 위 코드를 만들고 입력화면을 보여준 후 input box에 어떤 문자열을 입력한 후 전송 button을 클릭하면
	 * 이 method가 Request를 수신하고 input box에 입력한 문자열은 str 변수에 담기게 된다.
	 */
	...
	// localhost:8080/rootPath/dumy/gallery/detail/image 요청을 했을 때
	// request를 처리할 method
...
//	      model.addAttribute("file",fileName);
	...
	public String home(@RequestParam("one_file") MultipartFile one_file,
		 ...
		 * 
		 * m_file 객체에서 getFiles() method를 사용하여 파일들의 List를 추출한다.
